...
function healthBase(colors: ColorPalette, extra: Partial<Parameters<typeof definePreset>[0]> & {
  ...
  return definePreset({
    ...
    quickActions: qa([
      ["book", "Book an Appointment", "calendar", "send_text", "I'd like to book an appointment"],
      ["emergency", "Emergency Help", "alert", "send_text", "Is this an emergency?"],
      ["services", "Our Services", "stethoscope"],
      ["checkup", "Health Checkup", "heart"],
      ["insurance", "Insurance", "shield"],
      ["human", "Talk to Our Doctor", "headphones", "transfer_agent"],
    ]),
    suggestedQuestions: [
...
export const HEALTHCARE_PRESETS: CepIndustryPreset[] = [
  ...
  healthBase(
    ...
    },
    {
      ...
      greeting:
        "Hi! 🦷 Looking for a cleaning, checkup, or emergency dental help? Choose an option below.",
      matchKeywords: ["dental", "dentist", "teeth cleaning", "dental clinic", "oral health"],
      primaryCta: { label: "Book an Appointment", action: "book" },
      ...
      quickActions: qa([
        ["book", "Book an Appointment", "calendar", "send_text", "I'd like to book a dental appointment"],
        ["emergency", "Emergency Help", "alert", "send_text", "I need emergency dental help"],
        ["services", "Our Services", "stethoscope"],
        ["checkup", "Dental Checking", "heart", "send_text", "Tell me about dental checkups"],
        ["insurance", "Insurance", "shield"],
        ["human", "Talk to Our Doctor", "headphones", "transfer_agent"],
      ]),
    },
