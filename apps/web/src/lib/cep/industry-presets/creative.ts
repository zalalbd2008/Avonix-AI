...
function creativeBase(
  ...
  return definePreset({
    ...
    quickActions: qa([
      ["quote", "Get a quote", "calculator"],
      ["portfolio", "See work", "image"],
      ["packages", "Packages", "layers"],
...
export const CREATIVE_PRESETS: CepIndustryPreset[] = [
  creativeBase(
    ...
    },
    {
      ...
      assistantName: "Mark Maker",
      assistantRole: "Logo design intake specialist",
      greeting:
        "Need a logo that actually holds up? Tell me about your brand and I’ll help you start a brief or see packages.",
      matchKeywords: ["logo design", "logo designer", "brand mark", "logotype", "wordmark"],
      primaryCta: { label: "Start logo brief", action: "brief" },
      secondaryCta: { label: "See logo packages", action: "pricing" },
      bubbleCta: "Design a logo",
