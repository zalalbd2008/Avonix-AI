...
.avonix-form input:not([type="checkbox"]):not([type="radio"]):not([type="hidden"]):not([type="range"]):not([type="file"]):not([type="button"]):not([type="submit"]):not([type="reset"]):not([type="image"]):hover,.avonix-form select:hover,.avonix-form textarea:hover{border-color:var(--avx-input-hover-border,#c3ccd9)}
.avonix-form input:not([type="checkbox"]):not([type="radio"]):not([type="hidden"]):not([type="range"]):not([type="file"]):not([type="button"]):not([type="submit"]):not([type="reset"]):not([type="image"]):focus,.avonix-form select:focus,.avonix-form textarea:focus{outline:2px solid var(--avx-input-focus-border,#ff6600);outline-offset:-2px;border-color:var(--avx-input-focus-border,#ff6600);box-shadow:var(--avx-input-focus-shadow,inset 0 0 0 2px rgba(255,102,0,.35))}
...
.avonix-form input[type="checkbox"]{accent-color:var(--avx-check-on,#ff6600);width:var(--avx-check-size,18px);height:var(--avx-check-size,18px);min-height:0;min-width:0;padding:0;margin:0;border:0;border-radius:0;background:transparent;box-shadow:none;outline:none}
.avonix-form input[type="radio"]{accent-color:var(--avx-radio-on,#ff6600);width:var(--avx-radio-size,18px);height:var(--avx-radio-size,18px);min-height:0;min-width:0;padding:0;margin:0;border:0;border-radius:50%;background:transparent;box-shadow:none;outline:none}
.avonix-form input[type="checkbox"]:focus,.avonix-form input[type="radio"]:focus{outline:none;box-shadow:none;border:0}
...
.avonix-form.avx-a11y-focus input:not([type="checkbox"]):not([type="radio"]):not([type="hidden"]):not([type="range"]):not([type="file"]):focus-visible,.avonix-form.avx-a11y-focus select:focus-visible,.avonix-form.avx-a11y-focus textarea:focus-visible,.avonix-form.avx-a11y-focus button:focus-visible,.avonix-form.avx-a11y-focus a:focus-visible,.avonix-form.avx-a11y-focus [tabindex]:not(input[type="radio"]):not(input[type="checkbox"]):focus-visible{outline:3px solid var(--avx-input-focus-border,#ff6600);outline-offset:2px}
.avonix-form.avx-a11y-focus input[type="radio"]:focus-visible,.avonix-form.avx-a11y-focus input[type="checkbox"]:focus-visible{outline:none;outline-offset:0;box-shadow:none}
